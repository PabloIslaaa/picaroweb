...
const UI = {
    ...
    init() {
        this.els = {
            ...
            reloadTimer: document.getElementById('reload-timer'),
    ...
    showStartScreen() {
        ...
        this.els.reloadOverlay.classList.add('hidden');
    ...
    updateMenuStats() {
        const save = loadSave();
        this.els.menuChips.textContent = formatChips(save.totalChips);
        this.els.menuMaxChips.textContent = formatChips(save.maxChips);
        this.els.menuGamesPlayed.textContent = save.gamesPlayed;
    },
    ...
    // ---- Reload Overlay ----
    showReloadOverlay() {
        this.els.reloadOverlay.classList.remove('hidden');
        if (canFreeReload()) {
            this.els.reloadBtn.classList.remove('hidden');
            this.els.reloadTimer.classList.add('hidden');
        } else {
            this.els.reloadBtn.classList.add('hidden');
            this.els.reloadTimer.classList.remove('hidden');
            this.els.reloadTimer.textContent = `Next free reload: ${formatTimeRemaining(getTimeUntilReload())}`;
        }
    },
