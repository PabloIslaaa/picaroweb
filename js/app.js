...
const App = {
    ...
    // ---- Initialize ----
    init() {
        // Always clear any stale saved game data so we start fresh
        try { localStorage.removeItem('poker_holdem_save'); } catch (e) { }
    ...
    startGame() {
        ...
        // Always start fresh — hide any stale overlays
        UI.hideResult();
